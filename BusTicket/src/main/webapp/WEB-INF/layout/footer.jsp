...
<footer class="py-3 bg-dark text-white rounded" style="margin-top: 30px">
    <!--<h2 class="text-center">Bus Ticket Web Online</h2>-->
    ...
    <p class="text-center text-light">© 2022 DTK&NVP Company, Inc</p>
</footer>